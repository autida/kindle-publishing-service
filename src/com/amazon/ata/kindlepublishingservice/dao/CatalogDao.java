...
public class CatalogDao {
    ...
    public CatalogItemVersion createOrUpdateBook(KindleFormattedBook kindleFormattedBook) {
        // Add new book to catalogItem Version
        ...
        if(book == null) {
            ...
            throw new BookNotFoundException("New book added.");
        } else {
            // Update catalogItemVersion Inactive to true
            book.setInactive(true);
            dynamoDbMapper.save(book);
            // Save updated new version book
            ...
            catalogItemVersion.setVersion(book.getVersion() + 1);
