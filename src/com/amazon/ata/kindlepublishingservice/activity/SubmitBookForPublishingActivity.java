...
public class SubmitBookForPublishingActivity {
     ...
     */
    @Inject
    public SubmitBookForPublishingActivity(CatalogDao catalogDao, PublishingStatusDao publishingStatusDao, BookPublishRequestManager bookPublishRequestManager) {
    ...
    public SubmitBookForPublishingResponse execute(SubmitBookForPublishingRequest request) {
        ...
        PublishingStatusItem item = publishingStatusDao.setPublishingStatus(
                ...
                KindlePublishingUtils.generateBookId());
        System.out.println(item.getPublishingRecordId() + bookPublishRequest.getPublishingRecordId());
